...
export default function HeroSection() {
    return (
        <div className="h-screen w-full flex justify-center items-center text-center">
            <div>
                <h1 className="text-black dark:text-white text-[4.5rem] font-bold pb-2">Olá, eu sou o Nathan</h1>
                <h3 className="text-xl text-muted-foreground text-balance pb-6 max-w-[42rem] mx-auto">Bem vindo ao meu blog. Esse blog foi feito utilizando Nextjs 14, TailwindCSS, Shadcn/ui, Velite, e MDX.</h3>
